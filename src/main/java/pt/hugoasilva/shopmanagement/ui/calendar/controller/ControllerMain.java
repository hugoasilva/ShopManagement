...
public class ControllerMain implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        labelMonth.setText(LocalDate.now().getMonth().getDisplayName(TextStyle.FULL_STANDALONE,
                new Locale("pt", "PT")));
        selectedMonth = LocalDate.now().getMonth().getDisplayName(TextStyle.FULL_STANDALONE,
                new Locale("pt", "PT"));
...
//            System.out.println(anchorPane.getDate());
    ...
    private void onButtonJanuaryClicked(ActionEvent event) {
        labelMonth.setText("janeiro");
        hideShowNav(0);
        changeCalendar(Integer.parseInt(labelYear.getText()), "janeiro");
    }

    @FXML
    private void onButtonFebruaryClicked(ActionEvent event) {
        labelMonth.setText("fevereiro");
        hideShowNav(1);
        changeCalendar(Integer.parseInt(labelYear.getText()), "fevereiro");
    }

    @FXML
    private void onButtonMarchClicked(ActionEvent event) {
        labelMonth.setText("março");
        hideShowNav(2);
        changeCalendar(Integer.parseInt(labelYear.getText()), "março");
    }

    @FXML
    private void onButtonAprilClicked(ActionEvent event) {
        labelMonth.setText("abril");
        hideShowNav(3);
        changeCalendar(Integer.parseInt(labelYear.getText()), "abril");
    }

    @FXML
    private void onButtonMayClicked(ActionEvent event) {
        labelMonth.setText("maio");
        hideShowNav(4);
        changeCalendar(Integer.parseInt(labelYear.getText()), "maio");
    }

    @FXML
    private void onButtonJuneClicked(ActionEvent event) {
        labelMonth.setText("junho");
        hideShowNav(5);
        changeCalendar(Integer.parseInt(labelYear.getText()), "junho");
    }

    @FXML
    private void onButtonJulyClicked(ActionEvent event) {
        labelMonth.setText("julho");
        hideShowNav(6);
        changeCalendar(Integer.parseInt(labelYear.getText()), "julho");
    }

    @FXML
    private void onButtonAugustClicked(ActionEvent event) {
        labelMonth.setText("agosto");
        hideShowNav(7);
        changeCalendar(Integer.parseInt(labelYear.getText()), "agosto");
    }

    @FXML
    private void onButtonSeptemberClicked(ActionEvent event) {
        labelMonth.setText("setembro");
        hideShowNav(8);
        changeCalendar(Integer.parseInt(labelYear.getText()), "setembro");
    }

    @FXML
    private void onButtonOctoberClicked(ActionEvent event) {
        labelMonth.setText("outubro");
        hideShowNav(9);
        changeCalendar(Integer.parseInt(labelYear.getText()), "outubro");
    }

    @FXML
    private void onButtonNovemberClicked(ActionEvent event) {
        labelMonth.setText("novembro");
        hideShowNav(10);
        changeCalendar(Integer.parseInt(labelYear.getText()), "novembro");
    }

    @FXML
    private void onButtonDecemberClicked(ActionEvent event) {
        labelMonth.setText("dezembro");
        hideShowNav(11);
        changeCalendar(Integer.parseInt(labelYear.getText()), "dezembro");
    }
