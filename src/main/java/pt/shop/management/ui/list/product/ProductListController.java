package main.java.pt.shop.management.ui.list.product;
...
import main.java.pt.shop.management.ui.add.product.ProductAddController;
import main.java.pt.shop.management.ui.alert.AlertMaker;
import main.java.pt.shop.management.ui.details.product.ProductDetailsController;
        ...
        if (answer.get() == ButtonType.OK) {
            ...
            if (result) {
                ...
                AlertMaker.showSimpleAlert("Erro!",
                        "Não foi possível apagar o produto " + selectedForDeletion.getName());
            }
        } else {
