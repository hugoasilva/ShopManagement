package pt.shop.management.ui.dialog.alert;
...
/**
 * JFXAlert is similar to JFXDialog control, however it extends JavaFX Dialog
 ...
 * @since 2017-05-26
 */
public class MaterialAlert<R> extends Dialog<R> {
    ...
    public MaterialAlert(Window window) {
        // create content
