package pt.shop.management.ui.material.button;
...
import pt.shop.management.ui.material.button.MaterialButton.ButtonType;
...
//        button.addEventHandler(MouseEvent.MOUSE_RELEASED, e -> playClickAnimation(-1));
    ...
    protected void layoutChildren(final double x, final double y, final double w, final double h) {
        if (invalid) {
            if (((MaterialButton) getSkinnable()).getRipplerFill() == null) {
                ...
                buttonRippler.setRipplerFill(((MaterialButton) getSkinnable()).getRipplerFill());
            }
            invalid = false;
        }
